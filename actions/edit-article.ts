...
export const editArticle = async (articleId: string, prevState: createArticlesFormstate, formData: FormData): Promise<createArticlesFormstate> => {
    ...
    if (!existingUser || existingArticle.authorId !== existingUser.id) {
        return {
            errors: {
                formErrors: ['User not found plz resister'],
            }
        }
    }
    ...
    try {
        ...
        if (error instanceof Error) {
            ...
            return {
                errors: {
                    formErrors: ["some internal error occured"]
                }
            }
        }
    }
...
//         where: { clerkUserId: userId }
//     })
//     if (!existingUser || existingArticle.authorId !== userId) {
//         return {
//             errors: {
//                 formErrors: ['User not found plz resister'],
//             }
...
//                 return {
//                     errors: {
//                         featuredImage: ['failed to upload image plz try again']
//                     }
//                 }
//             }
//         } catch (error) {
...
//                 return {
//                     errors: {
//                         formErrors: ['error uploading image plz try again']
//                     }
//                 }
//             }
//         }
